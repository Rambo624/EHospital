...
def dashboard(request):
    ...
    appointments = base_models.Appointments.objects.filter(patient=patient)
...
def appointment_detail(request, appointment_id):
    patient = patient_models.Patient.objects.get(user=request.user)
    appointment = base_models.Appointments.objects.get(appointment_id=appointment_id, patient=patient)
