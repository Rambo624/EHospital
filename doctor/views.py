...
def dashboard(request):
    ...
    appointments = base_models.Appointments.objects.filter(doctor=doctor)
...
def appointment_detail(request, appointment_id):
    doctor = doctor_models.Doctor.objects.get(user=request.user)
    appointment = base_models.Appointments.objects.get(appointment_id=appointment_id, doctor=doctor)
...
def profile(request):
    ...
    if request.method == "POST":
        ...
        years_of_experiance = request.POST.get("years_of_experiance")
        ...
        doctor.years_of_experiance = years_of_experiance
